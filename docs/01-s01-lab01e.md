...
**Worth noting:** In basic R Scripts, `#` at the start of the line would result in turning the line into a <a class='glossary' target='_blank' title='' href='https://psyteachr.github.io/glossary/c#comment'>comment</a>. Here, in R Markdown,  `#` sets the header size much like a Word document header
