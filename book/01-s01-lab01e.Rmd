...
**Worth noting:** In basic R Scripts, `#` at the start of the line would result in turning the line into a `r glossary("comment")`. Here, in R Markdown,  `#` sets the header size much like a Word document header
...
```
![The Ponzo Illusion](https://en.wikipedia.org/wiki/Ponzo_illusion#/media/File:Ponzo_illusion.gif)
```
